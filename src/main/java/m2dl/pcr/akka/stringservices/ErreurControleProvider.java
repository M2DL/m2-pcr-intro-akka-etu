...
public class ErreurControleProvider extends UntypedActor {
    ...
    public void onReceive(Object msg) throws Exception {
        if (msg instanceof Message) {
            ...
            log.info("add error control to \"" + message.getContenu() + "\" and send the result to " + message.getRecepteur().path().name());
            String res = StringUtils.ajouteCtrl(message.getContenu()) ;
